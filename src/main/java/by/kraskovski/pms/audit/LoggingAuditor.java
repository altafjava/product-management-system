...
public class LoggingAuditor implements Auditing {
	...
	@Override
	public void logService(final String serviceName, final String methodName, final Object[] args) {
		validateServiceName(serviceName);
		validateMethodName(methodName);
		log.info("Message : Called service: {} for method: {} with arguments: {}", serviceName, methodName, args);
	}
	...
	public void logException(final String serviceName, final Throwable exception) {
		...
		log.info("Message : Thrown exception: '{}' in service: {}", exception, serviceName);
	}
